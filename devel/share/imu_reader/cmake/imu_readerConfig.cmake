...
if("TRUE" STREQUAL "TRUE")
  set(imu_reader_SOURCE_PREFIX /home/ubuntu/Documents/diff_drive_tut/src/imu_reader)
  set(imu_reader_DEVEL_PREFIX /home/ubuntu/Documents/diff_drive_tut/devel)
  ...
  set(imu_reader_INSTALL_PREFIX /home/ubuntu/Documents/diff_drive_tut/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imu_reader' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'imu_reader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Documents/diff_drive_tut/src/imu_reader/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT imu_reader_NUM_DUMMY_TARGETS)
      set(imu_reader_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::imu_reader::wrapped-linker-option${imu_reader_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR imu_reader_NUM_DUMMY_TARGETS "${imu_reader_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::imu_reader::wrapped-linker-option${imu_reader_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND imu_reader_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/Documents/diff_drive_tut/devel/lib;/home/ubuntu/Documents/diff_drive_tut/devel/lib;/opt/ros/noetic/lib)
...
set(imu_reader_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${imu_reader_dep}_FOUND)
      find_package(${imu_reader_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${imu_reader_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(imu_reader_EXPORTED_TARGETS ${${imu_reader_dep}_EXPORTED_TARGETS})
endforeach()
